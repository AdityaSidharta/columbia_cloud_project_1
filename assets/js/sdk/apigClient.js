...
apigClientFactory.newClient = function (config) {
    ...
    if(config === undefined) {
        config = {
            accessKey: 'AKIASAYYBT4ZFFDRWIUR',
            secretKey: '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',
            sessionToken: '',
            region: '',
            apiKey: undefined,
    ...
    var invokeUrl = 'https://vf6f8as841.execute-api.us-east-1.amazonaws.com/test0';
